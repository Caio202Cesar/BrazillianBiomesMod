...
public abstract class TreeFeatures implements IFeatureConfig {
    ...
    public static final ConfiguredFeature<?, ?> SERRA_DO_MAR_FOREST_TREES = register("serra_do_mar_forest_trees",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(MANACA_TREE.withChance(0.35F),
                    ...
                    JUSSARA_PALM.withChance(0.44F), CECROPIA_TREE.withChance(0.094F), STRAWBERRY_GUAVA_TREE.withChance(0.32F),
    ...
    public static final ConfiguredFeature<?, ?> VARZEA_TREES = register("varzea_trees",
            Feature.RANDOM_SELECTOR.withConfiguration(new MultipleRandomFeatureConfig(ImmutableList.of(CECROPIA_TREE.withChance(0.09F),
                            ...
                            YOUNG_KAPOK_TREE.withChance(0.4F), AMAZON_YELLOW_IPE_TREE.withChance(0.26F), AMAZON_PURPLE_IPE_TREE.withChance(0.26F),
