...
public class PurplePassionFruitVineLeavesDecorator extends TreeDecorator {
    // Create a unit codec for this decorator.
    public static final Codec<PurplePassionFruitVineLeavesDecorator> CODEC = Codec.unit(PurplePassionFruitVineLeavesDecorator::new);
    public static final PurplePassionFruitVineLeavesDecorator INSTANCE = new PurplePassionFruitVineLeavesDecorator();

    @Override
    protected TreeDecoratorType<?> getDecoratorType() {
        // Return your registered TreeDecoratorType – ensure you've registered it with your mod's modid.
        return ModTreeDecorators.PURPLE_PASSIONVINE_DECORATOR.get();
    }
