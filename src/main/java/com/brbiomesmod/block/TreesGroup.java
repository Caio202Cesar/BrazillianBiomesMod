...
public class TreesGroup {
    ...
    public static final RegistryObject<Block> PURPLE_IPE_BLOSSOM = registerBlock("purple_ipe_blossom",
            () -> new PurpleIpeBlossom(AbstractBlock.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly()
                    .notSolid().sound(SoundType.PLANT).harvestTool(ToolType.HOE), TreesGroup.PURPLE_IPE_BRANCHES));
    public static final RegistryObject<Block> PURPLE_IPE_BRANCHES = registerBlock("purple_ipe_branches",
            () -> new PurpleIpeFallLeaves(AbstractBlock.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly()
                    .notSolid().sound(SoundType.PLANT).harvestTool(ToolType.HOE)));
    ...
    public static final RegistryObject<Block> MANGABA_DRIED_BRANCHES = registerBlock("mangaba_dried_branches",
            () -> new MangabaDriedBranches(AbstractBlock.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly()
                    .notSolid().sound(SoundType.PLANT).harvestTool(ToolType.HOE), TreesGroup.MANGABA_LEAVES));
    ...
    public static final RegistryObject<Block> JENIPAPO_SAPLING = registerBlock("jenipapo_sapling",
            JenipapoSapling::new);
    @SuppressWarnings("deprecation")
    public static final RegistryObject<Block> POTTED_JENIPAPO_SAPLING = BLOCKS.register("potted_jenipapo_sapling",
            () -> new FlowerPotBlock(TreesGroup.JENIPAPO_SAPLING.get(), AbstractBlock.Properties.create(Material.MISCELLANEOUS)
                    .zeroHardnessAndResistance().notSolid()));
    ...
    @SuppressWarnings("deprecation")
    public static final RegistryObject<Block> POTTED_GUAPURUVU_SAPLING = BLOCKS.register("potted_guapuruvu_sapling",
            () -> new FlowerPotBlock(TreesGroup.GUAPURUVU_SAPLING.get(), AbstractBlock.Properties.create(Material.MISCELLANEOUS)
                    .zeroHardnessAndResistance().notSolid()));
    ...
    @SuppressWarnings("deprecation")
    public static final RegistryObject<Block> POTTED_YELLOW_MOMBIN_SAPLING = BLOCKS.register("potted_yellow_mombin_sapling",
            () -> new FlowerPotBlock(TreesGroup.YELLOW_MOMBIN_SAPLING.get(), AbstractBlock.Properties.create(Material.MISCELLANEOUS)
                    .zeroHardnessAndResistance().notSolid()));
    ...
    public static final RegistryObject<Block> PEQUI_SAPLING = registerBlock("pequi_sapling",
            PequiSapling::new);
    @SuppressWarnings("deprecation")
    public static final RegistryObject<Block> POTTED_PEQUI_SAPLING = BLOCKS.register("potted_pequi_sapling",
    ...
    @SuppressWarnings("deprecation")
    public static final RegistryObject<Block> POTTED_SANDBOX_TREE_SAPLING = BLOCKS.register("potted_sandbox_tree_sapling",
    ...
    //Myrtaceae = use Myrtaceae Log from Caio Cesar's Biomes.
...
*/
    ...
    public static final RegistryObject<Block> CAGAITA_DRIED_BRANCHES = registerBlock("cagaita_dried_branches",
            () -> new CagaitaDriedBranches(AbstractBlock.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly()
                    .notSolid().sound(SoundType.PLANT).harvestTool(ToolType.HOE), TreesGroup.CAGAITA_BUDDING_LEAVES));
    public static final RegistryObject<Block> CAGAITA_BUDDING_LEAVES = registerBlock("cagaita_budding_leaves",
            () -> new CagaitaBuddingLeaves(AbstractBlock.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly()
