...
public class ApricotIpeSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(PlantsGroup.APRICOT_IPE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(PlantsGroup.POTTED_APRICOT_IPE_SAPLING.get(), RenderType.getCutout());
