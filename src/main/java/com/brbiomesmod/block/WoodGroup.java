...
public class WoodGroup {
    ...
    public static final RegistryObject<Block> PINK_PEROBA_WOOD = registerBlock("pink_peroba_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_PINK_PEROBA_WOOD = registerBlock("stripped_pink_peroba_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> STRIPPED_WHITE_JEQUITIBA_LOG = registerBlock("stripped_white_jequitiba_log",
            ModLogs::new);
    public static final RegistryObject<Block> WHITE_JEQUITIBA_WOOD = registerBlock("white_jequitiba_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_WHITE_JEQUITIBA_WOOD = registerBlock("stripped_white_jequitiba_wood",
            ModLogs::new);
    public static final RegistryObject<Block> WHITE_JEQUITIBA_PLANKS = registerBlock("white_jequitiba_planks",
            ModPlanks::new);
    public static final RegistryObject<Block> WHITE_JEQUITIBA_SLAB = registerBlock("white_jequitiba_slab",
            () -> new SlabBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    public static final RegistryObject<Block> WHITE_JEQUITIBA_STAIRS = registerBlock("white_jequitiba_stairs",
            () -> new StairsBlock(() -> WHITE_JEQUITIBA_PLANKS.get().getDefaultState(), AbstractBlock.Properties.create(Material.WOOD)
                    .harvestLevel(1).harvestTool(ToolType.AXE)));
    public static final RegistryObject<Block> WHITE_JEQUITIBA_FENCE = registerBlock("white_jequitiba_fence",
            () -> new FenceBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    public static final RegistryObject<Block> WHITE_JEQUITIBA_FENCE_GATE = registerBlock("white_jequitiba_fence_gate",
            () -> new FenceGateBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    ...
    public static final RegistryObject<Block> IPE_WOOD = registerBlock("ipe_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_IPE_WOOD = registerBlock("stripped_ipe_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> LOPHANTERA_WOOD = registerBlock("lophantera_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_LOPHANTERA_WOOD = registerBlock("stripped_lophantera_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> BRAZILNUT_WOOD = registerBlock("brazilnut_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_BRAZILNUT_WOOD = registerBlock("stripped_brazilnut_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> SHARINGA_WOOD = registerBlock("sharinga_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_SHARINGA_WOOD = registerBlock("stripped_sharinga_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> BACURI_WOOD = registerBlock("bacuri_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_BACURI_WOOD = registerBlock("stripped_bacuri_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> SOMBREIRO_WOOD = registerBlock("sombreiro_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_SOMBREIRO_WOOD = registerBlock("stripped_sombreiro_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> SCHINUS_WOOD = registerBlock("schinus_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_SCHINUS_WOOD = registerBlock("stripped_schinus_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> JUA_WOOD = registerBlock("jua_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_JUA_WOOD = registerBlock("stripped_jua_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> SAPUCAIA_WOOD = registerBlock("sapucaia_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_SAPUCAIA_WOOD = registerBlock("stripped_sapucaia_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> BRAZILLIAN_ROSEWOOD_WOOD = registerBlock("brazillian_rosewood_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_BRAZILLIAN_ROSEWOOD_WOOD = registerBlock("stripped_brazillian_rosewood_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> BRAZILWOOD_WOOD = registerBlock("brazilwood_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_BRAZILWOOD_WOOD = registerBlock("stripped_brazilwood_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> BLACK_SUCUPIRA_WOOD = registerBlock("black_sucupira_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_BLACK_SUCUPIRA_WOOD = registerBlock("stripped_black_sucupira_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> MONKEY_CAJARANA_WOOD = registerBlock("monkey_cajarana_wood",
            ModLogs::new);
    public static final RegistryObject<Block> STRIPPED_MONKEY_CAJARANA_WOOD = registerBlock("stripped_monkey_cajarana_wood",
            ModLogs::new);
    ...
    public static final RegistryObject<Block> PURPLEHEART_PLANKS = registerBlock("purpleheart_planks",
            ModPlanks::new);
    public static final RegistryObject<Block> PURPLEHEART_SLAB = registerBlock("purpleheart_slab",
            () -> new SlabBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    public static final RegistryObject<Block> PURPLEHEART_STAIRS = registerBlock("purpleheart_stairs",
            () -> new StairsBlock(() -> PURPLEHEART_PLANKS.get().getDefaultState(), AbstractBlock.Properties.create(Material.WOOD)
                    .harvestLevel(1).harvestTool(ToolType.AXE)));
    public static final RegistryObject<Block> PURPLEHEART_FENCE = registerBlock("purpleheart_fence",
            () -> new FenceBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    public static final RegistryObject<Block> PURPLEHEART_FENCE_GATE = registerBlock("purpleheart_fence_gate",
            () -> new FenceGateBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    ...
    public static final RegistryObject<Block> GUAPURUVU_PLANKS = registerBlock("guapuruvu_planks",
            ModPlanks::new);
    public static final RegistryObject<Block> GUAPURUVU_SLAB = registerBlock("guapuruvu_slab",
            () -> new SlabBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    public static final RegistryObject<Block> GUAPURUVU_STAIRS = registerBlock("guapuruvu_stairs",
            () -> new StairsBlock(() -> GUAPURUVU_PLANKS.get().getDefaultState(), AbstractBlock.Properties.create(Material.WOOD)
                    .harvestLevel(1).harvestTool(ToolType.AXE)));
    public static final RegistryObject<Block> GUAPURUVU_FENCE = registerBlock("guapuruvu_fence",
            () -> new FenceBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    public static final RegistryObject<Block> GUAPURUVU_FENCE_GATE = registerBlock("guapuruvu_fence_gate",
            () -> new FenceGateBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    ...
    public static final RegistryObject<Block> PEQUI_PLANKS = registerBlock("pequi_planks",
            ModPlanks::new);
    public static final RegistryObject<Block> PEQUI_SLAB = registerBlock("pequi_slab",
            () -> new SlabBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    public static final RegistryObject<Block> PEQUI_STAIRS = registerBlock("pequi_stairs",
            () -> new StairsBlock(() -> PEQUI_PLANKS.get().getDefaultState(), AbstractBlock.Properties.create(Material.WOOD)
                    .harvestLevel(1).harvestTool(ToolType.AXE)));
    public static final RegistryObject<Block> PEQUI_FENCE = registerBlock("pequi_fence",
            () -> new FenceBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    public static final RegistryObject<Block> PEQUI_FENCE_GATE = registerBlock("pequi_fence_gate",
            () -> new FenceGateBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    ...
    public static final RegistryObject<Block> OITI_PLANKS = registerBlock("oiti_planks",
            ModPlanks::new);
    public static final RegistryObject<Block> OITI_SLAB = registerBlock("oiti_slab",
            () -> new SlabBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    public static final RegistryObject<Block> OITI_STAIRS = registerBlock("oiti_stairs",
            () -> new StairsBlock(() -> OITI_PLANKS.get().getDefaultState(), AbstractBlock.Properties.create(Material.WOOD)
                    .harvestLevel(1).harvestTool(ToolType.AXE)));
    public static final RegistryObject<Block> OITI_FENCE = registerBlock("oiti_fence",
            () -> new FenceBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
    public static final RegistryObject<Block> OITI_FENCE_GATE = registerBlock("oiti_fence_gate",
            () -> new FenceGateBlock(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(2).harvestTool(ToolType.AXE)
                    .hardnessAndResistance(3f)));
