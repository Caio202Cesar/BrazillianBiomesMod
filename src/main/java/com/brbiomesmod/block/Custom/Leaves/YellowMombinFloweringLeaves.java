...
public class YellowMombinFloweringLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public YellowMombinFloweringLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        //Tropical biomes
        if (temp >= 0.9F && "SPRING".equals(currentSeason) && nextStage != null && random.nextInt(20) == 0) {
        ...
        //Subtropical biomes
        if (temp <= 0.89F && "SUMMER".equals(currentSeason) && nextStage != null && random.nextInt(20) == 0) {
