...
public class YellowMombinFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public YellowMombinFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        //Tropical biomes
        if (temp >= 0.9F && "SUMMER".equals(currentSeason) && nextStage != null && random.nextInt(10) == 0) {

            int dropCount = 1;

            ItemStack itemStack = new ItemStack(ModItems.YELLOW_MOMBIN.get(), dropCount);
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, TreesGroup.YELLOW_MOMBIN_LEAVES.get().getDefaultState());
