...
public class BlackPitangaWinterFloweringLeaves extends LeavesBlock implements IForgeShearable {
    public BlackPitangaWinterFloweringLeaves(Properties properties) {
        super(properties);
    }
