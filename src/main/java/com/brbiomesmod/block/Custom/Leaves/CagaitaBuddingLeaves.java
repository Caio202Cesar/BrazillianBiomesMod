...
public class CagaitaBuddingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public CagaitaBuddingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
