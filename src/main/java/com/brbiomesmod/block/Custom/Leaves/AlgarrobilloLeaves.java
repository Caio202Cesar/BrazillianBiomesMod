...
public class AlgarrobilloLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public AlgarrobilloLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
