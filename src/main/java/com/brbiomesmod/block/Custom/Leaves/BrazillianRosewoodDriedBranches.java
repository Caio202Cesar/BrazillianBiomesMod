...
public class BrazillianRosewoodDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BrazillianRosewoodDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
