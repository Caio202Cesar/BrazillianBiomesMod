...
public class BlackPitangaFruitingLeaves extends LeavesBlock implements IForgeShearable {
    ...
    public BlackPitangaFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, TreesGroup.BLACK_PITANGA_LEAVES.get().getDefaultState());
