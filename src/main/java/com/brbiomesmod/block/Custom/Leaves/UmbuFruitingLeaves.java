...
public class UmbuFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public UmbuFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, CaatingaBlocks.UMBU_LEAVES.get().getDefaultState());
