...
public class HumboldtWillowLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public HumboldtWillowLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
