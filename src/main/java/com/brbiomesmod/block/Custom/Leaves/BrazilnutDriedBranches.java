...
public class BrazilnutDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BrazilnutDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
