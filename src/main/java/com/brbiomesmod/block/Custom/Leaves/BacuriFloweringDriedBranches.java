...
public class BacuriFloweringDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BacuriFloweringDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
