...
public class BacuriFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BacuriFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if ("SPRING".equals(currentSeason) && nextStage != null && random.nextInt(10) == 0) {
            ...
            ItemStack itemStack = new ItemStack(ModItems.BACURI.get(), dropCount);
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, TreesGroup.BACURI_LEAVES.get().getDefaultState());
