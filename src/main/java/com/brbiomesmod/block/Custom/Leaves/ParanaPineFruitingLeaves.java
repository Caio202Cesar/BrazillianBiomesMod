...
public class ParanaPineFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public ParanaPineFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if (!worldIn.isRemote) {
            ...
            worldIn.setBlockState(pos, AraucariaPlateauBlocks.PARANA_PINE_LEAVES.get().getDefaultState());
