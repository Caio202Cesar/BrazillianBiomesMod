...
public class BlackSucupiraFruitingLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BlackSucupiraFruitingLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if ("SPRING".equals(currentSeason) && nextStage != null && random.nextInt(45) == 0) {
