...
public class HumboldtWillowFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public HumboldtWillowFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
