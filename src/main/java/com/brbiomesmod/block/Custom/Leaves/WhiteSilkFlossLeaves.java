...
public class WhiteSilkFlossLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public WhiteSilkFlossLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
