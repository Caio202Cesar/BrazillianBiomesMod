...
public class AlgarrobilloDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public AlgarrobilloDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
