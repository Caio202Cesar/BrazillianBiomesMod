...
public class SombreiroLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public SombreiroLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp > 0.9F && "FALL".equals(currentSeason) && nextStage != null && random.nextInt(45) == 0) {
