...
public class BlackSucupiraBlossom extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BlackSucupiraBlossom(Properties properties, Supplier<Block> nextStage) {
        super(properties);
