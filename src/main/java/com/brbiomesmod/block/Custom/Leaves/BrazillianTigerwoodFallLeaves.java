...
public class BrazillianTigerwoodFallLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BrazillianTigerwoodFallLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
