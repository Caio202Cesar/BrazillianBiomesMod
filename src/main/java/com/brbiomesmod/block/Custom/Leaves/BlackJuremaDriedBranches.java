...
public class BlackJuremaDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BlackJuremaDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
