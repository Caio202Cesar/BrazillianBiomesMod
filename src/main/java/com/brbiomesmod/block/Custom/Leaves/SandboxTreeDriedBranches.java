...
public class SandboxTreeDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public SandboxTreeDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp < 0.89F && "SPRING".equals(currentSeason) && nextStage != null && random.nextInt(5) == 0) {
