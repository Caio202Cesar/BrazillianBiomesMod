...
public class HumboldtWillowBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public HumboldtWillowBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
