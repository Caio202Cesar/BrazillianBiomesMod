...
public class BrazillianPepperLeaves extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BrazillianPepperLeaves(Properties properties, Supplier<Block> nextStage) {
        super(properties);
