...
public class BacuriDriedBranches extends LeavesBlock implements IForgeShearable {
    private final Supplier<Block> nextStage;

    public BacuriDriedBranches(Properties properties, Supplier<Block> nextStage) {
        super(properties);
