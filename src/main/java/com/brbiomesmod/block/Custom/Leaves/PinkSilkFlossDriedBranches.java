...
public class PinkSilkFlossDriedBranches extends LeavesBlock implements IForgeShearable {
    public PinkSilkFlossDriedBranches(Properties properties) {
        super(properties);
    }
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
        ...
        if (temp < 0.89F && "SPRING".equals(currentSeason) && random.nextInt(25) == 0) {
            ...
            worldIn.setBlockState(pos, TreesGroup.PINK_SILK_FLOSS_LEAVES.get()
