...
public class PurpleIpeSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreesGroup.PURPLE_IPE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreesGroup.POTTED_PURPLE_IPE_SAPLING.get(), RenderType.getCutout());
