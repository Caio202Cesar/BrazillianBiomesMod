...
public class BrazillianRosewoodSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreesGroup.BRAZILLIAN_ROSEWOOD_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreesGroup.POTTED_BRAZILLIAN_ROSEWOOD_SAPLING.get(), RenderType.getCutout());
