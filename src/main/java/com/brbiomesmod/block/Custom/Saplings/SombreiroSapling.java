...
public class SombreiroSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreesGroup.SOMBREIRO_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreesGroup.POTTED_SOMBREIRO_SAPLING.get(), RenderType.getCutout());
