...
public class BabassuSapling extends SaplingBlock {
    public BabassuSapling() {
        super(new BabassuTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
                .sound(SoundType.PLANT));
    }

    @OnlyIn(Dist.CLIENT)
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreesGroup.BABASSU_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreesGroup.POTTED_BABASSU_SAPLING.get(), RenderType.getCutout());
    ...
    private static class BabassuTree extends Tree {
        ...
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.BABASSU_PALM;
        }
    }
}
