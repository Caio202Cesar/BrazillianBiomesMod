...
public class XaximSapling extends SaplingBlock {
    public XaximSapling() {
        super(new XaximTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
    ...
    private static class XaximTree extends Tree {
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.XAXIM_TREE;
        }
    }
}
