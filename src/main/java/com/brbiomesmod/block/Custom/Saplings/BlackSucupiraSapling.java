...
public class BlackSucupiraSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreesGroup.BLACK_SUCUPIRA_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreesGroup.POTTED_BLACK_SUCUPIRA_SAPLING.get(), RenderType.getCutout());
