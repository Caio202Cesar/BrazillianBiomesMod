...
public class ApricotIpeSapling extends SaplingBlock {
    ...
    public static void registerRenderLayer() {
        RenderTypeLookup.setRenderLayer(TreesGroup.APRICOT_IPE_SAPLING.get(), RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(TreesGroup.POTTED_APRICOT_IPE_SAPLING.get(), RenderType.getCutout());
