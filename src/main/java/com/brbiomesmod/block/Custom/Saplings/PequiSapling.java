...
public class PequiSapling extends SaplingBlock {
    public PequiSapling() {
        super(new PequiTree(), Properties.from(Blocks.OAK_SAPLING).hardnessAndResistance(0.0f)
    ...
    private static class PequiTree extends Tree {
        @Override
        protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getTreeFeature(Random random, boolean p_225546_2_) {
            return TreeFeatures.PEQUI_TREE;
        }
    }
}
