...
public class ModOreGeneration {
    public static void generateOres(final BiomeLoadingEvent event) {
        spawnOreInSpecificModBiome(CaatingaBiome.CAATINGA.get(), OreType.TOURMALINE_PARAIBA, event, Dimension.OVERWORLD.toString());
        spawnOreInSpecificBiome(Biomes.SAVANNA, OreType.TOURMALINE_PARAIBA, event, Dimension.OVERWORLD.toString());
        spawnOreInSpecificBiome(Biomes.SAVANNA_PLATEAU, OreType.TOURMALINE_PARAIBA, event, Dimension.OVERWORLD.toString());
        spawnOreInSpecificBiome(Biomes.SHATTERED_SAVANNA_PLATEAU, OreType.TOURMALINE_PARAIBA, event, Dimension.OVERWORLD.toString());
        spawnOreInSpecificBiome(Biomes.SHATTERED_SAVANNA, OreType.TOURMALINE_PARAIBA, event, Dimension.OVERWORLD.toString());
    }
