...
public static final RegistryObject<Biome> AMAZON_RAINFOREST = BIOMES.register("amazon_rainforest",
        () -> makAmazonRainforestBiome(() -> ModConfiguredSurfaceBuilders.FOREST_SURFACE, 0.1f, 0.126f));


private static Biome makAmazonRainforestBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
