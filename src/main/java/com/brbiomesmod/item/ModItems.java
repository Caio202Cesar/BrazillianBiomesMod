...
public class ModItems {
    ...
    public static final RegistryObject<Item> ACAI_JAM = ITEMS.register("acai_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> ACAI_JAM_TOAST = ITEMS.register("acai_jam_toast",
    ...
    public static final RegistryObject<Item> BACURI_JAM = ITEMS.register("bacuri_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> BACURI_JAM_TOAST = ITEMS.register("bacuri_jam_toast",
    ...
    public static final RegistryObject<Item> BURITI_PASTE = ITEMS.register("buriti_paste",
            () -> new Item(new Item.Properties().group(ModItemGroup.FOOD_GROUP).food(ModFoods.BURITI_PASTE)));
    ...
    public static final RegistryObject<Item> CUPUACU_ICE_CREAM = ITEMS.register("cupuacu_ice_cream",
            () -> new Item(new Item.Properties().group(ModItemGroup.FOOD_GROUP).food(ModFoods.CUPUACU_ICE_CREAM)));
    public static final RegistryObject<Item> CUPUACU_JAM = ITEMS.register("cupuacu_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    ...
    public static final RegistryObject<Item> BLACK_PITANGA_JAM = ITEMS.register("black_pitanga_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    ...
    public static final RegistryObject<Item> RIO_GRANDE_CHERRY_JAM = ITEMS.register("rio_grande_cherry_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> RIO_GRANDE_CHERRY_JAM_TOAST = ITEMS.register("rio_grande_cherry_jam_toast",
    ...
    public static final RegistryObject<Item> MANGABA_JAM = ITEMS.register("mangaba_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> MANGABA_JAM_TOAST = ITEMS.register("mangaba_jam_toast",
            () -> new Item(new Item.Properties().group(ModItemGroup.FOOD_GROUP).food(ModFoods.MANGABA_JAM_TOAST)));


    public static final RegistryObject<Item> BUTIA_JUICE = ITEMS.register("butia_juice",
            () -> new BeverageItem(new Item.Properties().group(ModItemGroup.FOOD_GROUP).maxStackSize(1)
                    .food(ModFoods.BUTIA_JUICE)));
    ...
    public static final RegistryObject<Item> BUTIA_JAM = ITEMS.register("butia_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> BUTIA_JAM_TOAST = ITEMS.register("butia_jam_toast",
            () -> new Item(new Item.Properties().group(ModItemGroup.FOOD_GROUP).food(ModFoods.BUTIA_JAM_TOAST)));
    ...
    public static final RegistryObject<Item> FEIJOA_JAM = ITEMS.register("feijoa_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> FEIJOA_JAM_TOAST = ITEMS.register("feijoa_jam_toast",
            () -> new Item(new Item.Properties().group(ModItemGroup.FOOD_GROUP).food(ModFoods.FEIJOA_JAM_TOAST)));
    ...
    public static final RegistryObject<Item> PASSIONFRUIT_JAM = ITEMS.register("passionfruit_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> PASSIONFRUIT_JAM_TOAST = ITEMS.register("passionfruit_jam_toast",
            () -> new Item(new Item.Properties().group(ModItemGroup.FOOD_GROUP).food(ModFoods.PASSIONFRUIT_JAM_TOAST)));
    ...
    public static final RegistryObject<Item> CAMU_CAMU_JAM = ITEMS.register("camu_camu_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> CAMU_CAMU_JAM_TOAST = ITEMS.register("camu_camu_jam_toast",
            () -> new Item(new Item.Properties().group(ModItemGroup.FOOD_GROUP).food(ModFoods.CAMU_CAMU_JAM_TOAST)));
    ...
    public static final RegistryObject<Item> UMBU_JAM = ITEMS.register("umbu_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> UMBU_JAM_TOAST = ITEMS.register("umbu_jam_toast",
    ...
    public static final RegistryObject<Item> TURK_TURBAN_BERRY_JAM = ITEMS.register("turk_turban_berry_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> TURK_TURBAN_BERRY_JAM_TOAST = ITEMS.register("turk_turban_berry_jam_toast",
            () -> new Item(new Item.Properties().group(ModItemGroup.FOOD_GROUP).food(ModFoods.TURK_TURBAN_BERRY_JAM_TOAST)));
    ...
    public static final RegistryObject<Item> YELLOW_MOMBIN_JAM = ITEMS.register("yellow_mombin_fruit_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> YELLOW_MOMBIN_JAM_TOAST = ITEMS.register("yellow_mombin_fruit_jam_toast",
            () -> new Item(new Item.Properties().group(ModItemGroup.FOOD_GROUP).food(ModFoods.YELLOW_MOMBIN_JAM_TOAST)));


    public static final RegistryObject<Item> WOLF_APPLE_JAM = ITEMS.register("wolf_apple_jam",
            () -> new JarItem(new Item.Properties().maxStackSize(1).group(ModItemGroup.FOOD_GROUP)));
    public static final RegistryObject<Item> WOLF_APPLE_JAM_TOAST = ITEMS.register("wolf_apple_jam_toast",
            () -> new Item(new Item.Properties().group(ModItemGroup.FOOD_GROUP).food(ModFoods.WOLF_APPLE_JAM_TOAST)));
