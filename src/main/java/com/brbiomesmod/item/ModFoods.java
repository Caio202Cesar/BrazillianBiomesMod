...
public class ModFoods extends Foods {
    ...
    public static final Food MONKEY_CAJARANA = (new Food.Builder()).hunger(2).saturation(0.3F)
            ...
            .effect(new EffectInstance(Effects.HUNGER, 1500, 3), 1.0F)
    ...
    public static final Food CAMU_CAMU_FRUITS = (new Food.Builder()).hunger(2).saturation(0.1F)
            .effect(new EffectInstance(Effects.REGENERATION, 100, 1), 1.0F)
            .effect(new EffectInstance(Effects.HEALTH_BOOST, 100, 1), 1.0F).build();
    ...
    public static final Food RIO_GRANDE_CHERRY_JAM_TOAST = (new Food.Builder()).hunger(4).saturation(0.5F).build();
    public static final Food PINK_PEEPER_JAM_TOAST = (new Food.Builder()).hunger(4).saturation(0.5F).build();
    public static final Food MANGABA_JAM_TOAST = (new Food.Builder()).hunger(4).saturation(0.5F).build();
    public static final Food BUTIA_JAM_TOAST = (new Food.Builder()).hunger(4).saturation(0.5F).build();
    public static final Food BUTIA_JUICE = (new Food.Builder()).hunger(4).saturation(0.1F).build();
    public static final Food FEIJOA_JAM_TOAST = (new Food.Builder()).hunger(4).saturation(0.5F).build();
    ...
    public static final Food CAGAITA_JUICE = (new Food.Builder()).hunger(4).saturation(0.1F).build();
    public static final Food CAGAITA_JAM_TOAST = (new Food.Builder()).hunger(4).saturation(0.5F).build();
    public static final Food JENIPAPO_JUICE = (new Food.Builder()).hunger(4).saturation(0.1F).build();
    ...
    public static final Food TURK_TURBAN_JAM_TOAST = (new Food.Builder()).hunger(4).saturation(0.5F).build();
    public static final Food TURK_TURBAN_BERRY_JAM_TOAST = (new Food.Builder()).hunger(4).saturation(0.5F).build();
    public static final Food CECROPIA_JUICE = (new Food.Builder()).hunger(4).saturation(0.1F).build();
