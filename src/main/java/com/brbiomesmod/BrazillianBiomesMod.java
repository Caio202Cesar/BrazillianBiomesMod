    ...
    private void setup(final FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            AxeItem.BLOCK_STRIPPING_MAP = new ImmutableMap.Builder<Block, Block>().putAll(AxeItem.BLOCK_STRIPPING_MAP)
                    ...
                    .put(WoodGroup.CAGAITA_WOOD.get(), WoodGroup.STRIPPED_EUGENIA_WOOD.get())
                    .put(WoodGroup.FEIJOA_WOOD.get(), WoodGroup.STRIPPED_FEIJOA_WOOD.get())
                    ...
                    .put(WoodGroup.PODOCARPUS_LAMBERTII_WOOD.get(), WoodGroup.STRIPPED_PODOCARPUS_LAMBERTII_WOOD.get())
                    ...
                    .put(WoodGroup.YERBA_MATE_WOOD.get(), WoodGroup.STRIPPED_YERBA_MATE_WOOD.get())
                    ...
                    .put(WoodGroup.JABUTICABA_WOOD.get(), WoodGroup.STRIPPED_JABUTICABA_WOOD.get())
