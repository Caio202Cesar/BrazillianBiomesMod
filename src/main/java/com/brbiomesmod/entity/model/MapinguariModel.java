...
public class MapinguariModel<T extends MapinguariEntity> extends EntityModel<T> {
    ...
    public MapinguariModel() {
        ...
        body.setRotationPoint(0.0F, 17.0F, 0.0F); // -7.0F offset converted
        ...
        head.setRotationPoint(0.0F, 17.0F, -2.0F);

        // ================= RIGHT ARM =================
        right_arm = new ModelRenderer(this);
        right_arm.setRotationPoint(0.0F, 17.0F, 0.0F);
        ...
        left_arm.setRotationPoint(0.0F, 17.0F, 0.0F);
