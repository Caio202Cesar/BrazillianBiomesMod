...
public class CapybaraModel<T extends CapybaraEntity> extends EntityModel<T> {
    ...
    public CapybaraModel() {
        ...
        body.setTextureOffset(0, 0).addBox(-4.0F, -8.0F, -5.0F, 6.0F, 7.0F, 11.0F, 0.0F, false);

        legFL = new ModelRenderer(this, 0, 18);
        legFL.setRotationPoint(0.0F, 23.0F, 0.0F);
        legFL.setTextureOffset(0, 30).addBox(0.0F, -2.0F, -4.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

        legFR = new ModelRenderer(this, 0, 18);
        legFR.setRotationPoint(0.0F, 23.0F, 0.0F);
        legFR.setTextureOffset(22, 26).addBox(-4.0F, -2.0F, -4.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

        legBL = new ModelRenderer(this, 0, 18);
        legBL.setRotationPoint(0.0F, 23.0F, 0.0F);
        legBL.setTextureOffset(22, 22).addBox(0.0F, -2.0F, 4.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

        legBR = new ModelRenderer(this, 0, 18);
        legBR.setRotationPoint(0.0F, 23.0F, 0.0F);
        legBR.setTextureOffset(22, 18).addBox(-4.0F, -2.0F, 4.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
