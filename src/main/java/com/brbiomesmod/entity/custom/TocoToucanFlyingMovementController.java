...
public class TocoToucanFlyingMovementController extends FlyingMovementController {
    private int field_226323_i_ = 0;
    private boolean field_226324_j_ = false;

    public TocoToucanFlyingMovementController(MobEntity p_i225710_1_, int p_i225710_2_, boolean p_i225710_3_) {
