...
public class TocoToucanEntity extends ParrotEntity {
    public TocoToucanEntity(EntityType<? extends ParrotEntity> type, World worldIn) {
        super(type, worldIn);
        this.moveController = new TocoToucanFlyingMovementController(this, 10, false);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.0D, Ingredient.fromItems(Items.WHEAT_SEEDS), false));
